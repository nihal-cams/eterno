...
class VideoSectionController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('thumbnail_image')) {
            ...
            if ($videoSection->thumbnail_image && file_exists(public_path('uploads/video-sections/' . $videoSection->thumbnail_image))) {
        ...
        if ($request->hasFile('video')) {
            ...
            if ($videoSection->video && file_exists(public_path('uploads/video-sections/' . $videoSection->video))) {
